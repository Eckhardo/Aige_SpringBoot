...
public class CountryData {
    ...
    public static List<Country> getCountries() {
        ...
        countries.add(new Country("�land Islands", "AX"));
        ...
        countries.add(new Country("Cote DIvoire", "CI"));
        ...
        countries.add(new Country("Korea, Democratic PeopleS Republic of", "KP"));
        countries.add(new Country("Korea, Republic of", "KR"));
        countries.add(new Country("Kuwait", "KW"));
        countries.add(new Country("Kyrgyzstan", "KG"));
        countries.add(new Country("Lao Peoples Democratic Republic", "LA"));
